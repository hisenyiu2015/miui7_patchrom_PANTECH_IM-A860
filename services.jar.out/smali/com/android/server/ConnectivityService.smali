...
.method public getMobileDataEnabled()Z
    ...
    invoke-static {v4}, Lcom/android/internal/telephony/dataconnection/ISkyDataConnection$Stub;->asInterface(Landroid/os/IBinder;)Lcom/android/internal/telephony/dataconnection/ISkyDataConnection;

    move-result-object v1

    .line 1965
    .local v1, "iDataCon":Lcom/android/internal/telephony/dataconnection/ISkyDataConnection;
    if-eqz v1, :cond_1

    invoke-interface {v1}, Lcom/android/internal/telephony/dataconnection/ISkyDataConnection;->isNetworkRoaming()Z
    ...
    const-string v6, "getMobileDataEnabled returning "
    ...
    .line 1978
    .end local v1    # "iDataCon":Lcom/android/internal/telephony/dataconnection/ISkyDataConnection;
    .end local v2    # "retVal":Z
    :goto_1
    return v2

    .restart local v1    # "iDataCon":Lcom/android/internal/telephony/dataconnection/ISkyDataConnection;
    :cond_0
    move v2, v3
...
.method public getMobileDataEnabledOEM(I)Z
    .locals 7
    .param p1, "networkType"    # I
    ...
    const-string v6, "getMobileDataEnabledOEM returning "
    ...
    invoke-interface {v1}, Lcom/android/internal/telephony/dataconnection/ISkyDataConnection;->getSKTSimCheck()Z
...
.method public removeRouteForVT(II)Z
    .locals 6
    .param p1, "networkType"    # I
...
.method public requestRouteToHostAddress(I[BLjava/lang/String;)Z
    ...
    .line 1689
    :cond_0
    invoke-virtual {p0, p1}, Lcom/android/server/ConnectivityService;->getMobileDataEnabledOEM(I)Z
    ...
    const-string v11, " requestRouteToHost, when Data is Disabled(SKT)"
...
.method private processUsingNetworkFeature(ILjava/lang/String;Landroid/os/IBinder;I)I
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/ConnectivityService;->getMobileDataEnabledOEM(I)Z
    ...
    const-string v23, "startUsingNetworkFeature-error : roaming is disabled"
    ...
    .line 1361
    invoke-virtual {v9}, Lcom/android/server/ConnectivityService$FeatureUser;->unlinkDeathRecipient()V
    :try_end_7
    .catchall {:try_start_7 .. :try_end_7} :catchall_1
    ...
    const-string v22, "com.pantech.CSP_MMS_ONOFF"
    ...
    .line 1463
    .end local v9    # "f":Lcom/android/server/ConnectivityService$FeatureUser;
    .end local v11    # "network":Landroid/net/NetworkStateTracker;
    .end local v12    # "networkMetered":Z
    .end local v20    # "uidRules":I
    .end local v21    # "usedNetworkType":I
    :cond_15
    ...
    .restart local v11    # "network":Landroid/net/NetworkStateTracker;
