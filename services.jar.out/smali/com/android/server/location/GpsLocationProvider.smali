...
.field public static final ASSISTED_GPS_OFF_ACTION:Ljava/lang/String; = "com.skt.intent.action.AGPS_OFF"

.field public static final ASSISTED_GPS_ON_ACTION:Ljava/lang/String; = "com.skt.intent.action.AGPS_ON"
...
.field private static final GPS_TMAP:I = 0x1
...
.field private mBackupGpsState:Z
...
.method public constructor <init>(Landroid/content/Context;Landroid/location/ILocationManager;Landroid/os/Looper;)V
    ...
    .line 324
    iput-boolean v7, p0, Lcom/android/server/location/GpsLocationProvider;->mBackupGpsState:Z
...
.method static synthetic access$600(Lcom/android/server/location/GpsLocationProvider;Landroid/os/Bundle;)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/location/GpsLocationProvider;
    ...
    .prologue
    .line 103
    invoke-direct {p0, p1}, Lcom/android/server/location/GpsLocationProvider;->setAgpsMode(Landroid/os/Bundle;)Z
...
.method private listenForBroadcasts()V
    ...
    .line 830
    .restart local v1    # "intentFilter":Landroid/content/IntentFilter;
    const-string v2, "com.skt.intent.action.GPS_TURN_OFF"
...
.method private reportLocation(IDDDFFFJ)V
    ...
    invoke-interface {v7}, Landroid/location/IGpsStatusListener;->onGpsFixFail()V
    :try_end_4
...
.method private setAgpsMode(Landroid/os/Bundle;)Z
    .locals 13
    ...
    const-string v8, "SKAF_setAgpsMode"
    ...
    const-string v7, "nSessionType"

    invoke-virtual {p1, v7}, Landroid/os/Bundle;->getChar(Ljava/lang/String;)C

    move-result v4

    .line 511
    .local v4, "nSessType":I
    const-string v7, "nGPRSAuthType"

    invoke-virtual {p1, v7}, Landroid/os/Bundle;->getChar(Ljava/lang/String;)C

    move-result v7

    iput v7, p0, Lcom/android/server/location/GpsLocationProvider;->mPrivacy:I

    .line 512
    const-string v7, "nTimeBetweenFix"
    ...
    iput v7, p0, Lcom/android/server/location/GpsLocationProvider;->mQoP:I
    ...
    .line 521
    invoke-direct {p0}, Lcom/android/server/location/GpsLocationProvider;->getGpsState()Z
    ...
    .line 522
    invoke-direct {p0}, Lcom/android/server/location/GpsLocationProvider;->setGpsEnable()V

    .line 523
    invoke-virtual {p0}, Lcom/android/server/location/GpsLocationProvider;->enable()V
    ...
    const-string v9, "AGPS_On mBackupGpsState : "

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    iget-boolean v9, p0, Lcom/android/server/location/GpsLocationProvider;->mBackupGpsState:Z
    ...
    .line 528
    const-string v1, "wpde.nate.com"

    .line 529
    .local v1, "SuplHost":Ljava/lang/String;
    const/16 v2, 0x1c6b

    .line 530
    .local v2, "SuplPort":I
    invoke-direct {p0, v10, v1, v2}, Lcom/android/server/location/GpsLocationProvider;->native_set_agps_server(ILjava/lang/String;I)V

    .line 531
    iput v10, p0, Lcom/android/server/location/GpsLocationProvider;->mServiceType:I

    .line 532
    const/16 v7, 0xe10

    iput v7, p0, Lcom/android/server/location/GpsLocationProvider;->mAccuracy:I

    .line 562
    .end local v1    # "SuplHost":Ljava/lang/String;
    .end local v2    # "SuplPort":I
    :cond_0
    if-ne v4, v10, :cond_3

    .line 564
    iput v10, p0, Lcom/android/server/location/GpsLocationProvider;->mSessionType:I

    .line 565
    iput v10, p0, Lcom/android/server/location/GpsLocationProvider;->mFixNum:I
    ...
    const-string v9, " ,mServiceType:"

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    iget v9, p0, Lcom/android/server/location/GpsLocationProvider;->mServiceType:I

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v8

    const-string v9, " ,mPrivacy:"

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    iget v9, p0, Lcom/android/server/location/GpsLocationProvider;->mPrivacy:I

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v8

    const-string v9, " ,mFixNum:"

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    iget v9, p0, Lcom/android/server/location/GpsLocationProvider;->mFixNum:I

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v8

    const-string v9, " ,mFixInterval:"
    ...
    const-string v9, " ,mQoP:"

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    iget v9, p0, Lcom/android/server/location/GpsLocationProvider;->mQoP:I

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v8

    const-string v9, " +mAccuracy:"

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    iget v9, p0, Lcom/android/server/location/GpsLocationProvider;->mAccuracy:I
    ...
    const-string v9, "AGPS_OFF mBackupGpsState : "
    ...
    .line 539
    iput v11, p0, Lcom/android/server/location/GpsLocationProvider;->mSessionType:I

    .line 540
    const v7, 0xffff

    iput v7, p0, Lcom/android/server/location/GpsLocationProvider;->mServiceType:I

    .line 541
    iput v11, p0, Lcom/android/server/location/GpsLocationProvider;->mPrivacy:I

    .line 542
    iput v12, p0, Lcom/android/server/location/GpsLocationProvider;->mFixNum:I
    ...
    .line 546
    iget-boolean v7, p0, Lcom/android/server/location/GpsLocationProvider;->mBackupGpsState:Z
    ...
    const-string v8, "setAgpsMode setGpsDisable()"

    invoke-static {v7, v8}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    .line 549
    invoke-direct {p0}, Lcom/android/server/location/GpsLocationProvider;->setGpsDisable()V
    ...
    const-string v8, "SessionMode  is default__Traking Mode"
    ...
    invoke-direct {p0, v7}, Lcom/android/server/location/GpsLocationProvider;->deleteAidingData(Landroid/os/Bundle;)Z
    ...
    const-string v8, "mPositionMode  is default__StandAlone"
...
.method private setGpsDisable()V
    .locals 4
    ...
    const-string v2, "com.skt.intent.action.AGPS_OFF"
...
.method private setGpsEnable()V
    ...
    const-string v2, "com.skt.intent.action.AGPS_ON"
...
.method private setGpsServer(Landroid/os/Bundle;)Z
    ...
    const-string v4, "[SKY DEBUG]setGpsServer - from test menu "

    invoke-static {v3, v4}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 485
    const-string v3, "mySuplHost"
    ...
    .line 489
    .local v0, "S_port":I
    invoke-direct {p0, v6, v1, v0}, Lcom/android/server/location/GpsLocationProvider;->native_set_agps_server(ILjava/lang/String;I)V
    ...
    const-string v5, "[SKY DEBUG]native_set_agps_server pde :"
...
.method private setOperationMode(Landroid/os/Bundle;)Z
    ...
    const-string v4, "[SKY DEBUG]default: mPositionMode : "
    ...
    const-string v4, "[SKY DEBUG]SET OPERATION MODE: mPositionMode :"
    ...
    const-string v4, "[SKY DEBUG]mSessionType:"
...
.method private startNavigating(Z)V
    ...
    const-string v1, "[SKY DEBUG]usig defualt - xtra enabled!"
    ...
    const-string v4, "[SKY DEBUG]DEFAULT GPS SETTING  mPositionMode : "
    ...
    const-string v4, "[SKY DEBUG]DEFAULT GPS SETTING   mFixInterval:  "
    ...
    const-string v1, " [SKY DEBUG]TelephonyManager.isNetworkRoaming() is true : position mode is standalone"
    ...
    const-string v4, "native_set_position_mode   mPositionMode : "
    ...
    const-string v4, " [SKY DEBUG]TelephonyManager.isNetworkRoaming() is false : Last check : position mode is "
...
.method private stopNavigating()V
    ...
    const-string v3, "[SKY DEBUG] mNavigating: "
...
.method public sendExtraCommand(Ljava/lang/String;Landroid/os/Bundle;)Z
    ...
    .line 1276
    invoke-direct {p0, p2}, Lcom/android/server/location/GpsLocationProvider;->setAgpsMode(Landroid/os/Bundle;)Z
    ...
    .line 1284
    :cond_5
    const-string v3, "set_Gps_Server"
