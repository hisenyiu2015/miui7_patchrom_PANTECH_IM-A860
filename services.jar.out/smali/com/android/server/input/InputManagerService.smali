...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Handler;)V
    ...
    iput-object v0, p0, Lcom/android/server/input/InputManagerService;->SKYSYSTEM_CLASS_NAME:Ljava/lang/String;
...
.method private getRearTouchSupportApp(I)I
    .locals 5
    .param p1, "defaultValue"    # I
    ...
    const-string v3, "rear_touch_support_app"
...
.method private registerRearSupportAppObserver()V
    .locals 5
    ...
    invoke-direct {p0, v0}, Lcom/android/server/input/InputManagerService;->getRearTouchSupportApp(I)I
    ...
    const-string v1, "rear_touch_support_app"
...
.method public start()V
    ...
    .line 302
    invoke-direct {p0}, Lcom/android/server/input/InputManagerService;->registerRearSupportAppObserver()V
...
.method public updateRearTouchFromSettings()V
    ...
    .line 1719
    invoke-direct {p0, v9}, Lcom/android/server/input/InputManagerService;->getRearTouchSetting(I)Z

    move-result v5

    .line 1720
    .local v5, "enable":Z
    invoke-direct {p0, v9}, Lcom/android/server/input/InputManagerService;->getRearTouchMode(I)I

    move-result v8

    .line 1722
    .local v8, "type":I
    iget-object v9, p0, Lcom/android/server/input/InputManagerService;->mWindowManagerCallbacks:Lcom/android/server/input/InputManagerService$WindowManagerCallbacks;

    invoke-interface {v9, v5, v8}, Lcom/android/server/input/InputManagerService$WindowManagerCallbacks;->notifyRearTouchStatus(ZI)V

    .line 1735
    const/4 v7, 0x0

    .line 1736
    .local v7, "mSkyCtrlDrv":Ljava/lang/Object;
    const/4 v0, 0x0

    .line 1738
    .local v0, "SkyCtrlBackTouch":Ljava/lang/reflect/Method;
    :try_start_0
    const-string v9, "com.pantech.test.Sky_ctrl_drv"
    ...
    .line 1743
    .local v1, "backTouchTypes":[Ljava/lang/Class;
    invoke-virtual {v7}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    move-result-object v9

    const-string v10, "Sky_Ctrl_BackTouch"
    ...
    const-string v10, "SkyCtrlBackTouch is Null!!"

    invoke-static {v9, v10}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;)I

    .line 1777
    .end local v1    # "backTouchTypes":[Ljava/lang/Class;
    .end local v2    # "cls":Ljava/lang/Class;, "Ljava/lang/Class<*>;"
    .end local v3    # "constructor":Ljava/lang/reflect/Constructor;
    .end local v7    # "mSkyCtrlDrv":Ljava/lang/Object;
    :cond_0
    :goto_0
    return-void
    ...
    .restart local v7    # "mSkyCtrlDrv":Ljava/lang/Object;
    :cond_1
    :try_start_1
    const-string v9, "InputManager"
    ...
    const-string v11, "Class Not Found Sky_ctrl_drv :"
    ...
    .restart local v1    # "backTouchTypes":[Ljava/lang/Class;
    .restart local v2    # "cls":Ljava/lang/Class;, "Ljava/lang/Class<*>;"
    ...
    .line 1765
    iget v9, p0, Lcom/android/server/input/InputManagerService;->mPtr:I

    invoke-static {v9}, Lcom/android/server/input/InputManagerService;->nativeFadeOemPointer(I)V
