...
.field private mFreqLimit:Lcom/pantech/test/Sky_ctrl_drv;

.field private mFreqLimitBatteryLevel:I

.field private mFreqLimitEnable:I
...
.field private seteco_one:I

.field private seteco_zero:I
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/LightsService;)V
    ...
    .line 140
    iput v2, p0, Lcom/android/server/BatteryService;->mFreqLimitEnable:I

    .line 141
    const/16 v1, 0x10

    iput v1, p0, Lcom/android/server/BatteryService;->mFreqLimitBatteryLevel:I

    .line 142
    iput v3, p0, Lcom/android/server/BatteryService;->seteco_one:I

    .line 143
    iput v2, p0, Lcom/android/server/BatteryService;->seteco_zero:I
    ...
    iput-object v1, p0, Lcom/android/server/BatteryService;->mFreqLimit:Lcom/pantech/test/Sky_ctrl_drv;
    ...
    iput-object v1, p0, Lcom/android/server/BatteryService;->mSkyTouch:Lcom/pantech/test/Sky_ctrl_drv;
...
.method private final battCheckFreqLimit()V
    .locals 5
    ...
    iget v3, p0, Lcom/android/server/BatteryService;->mFreqLimitBatteryLevel:I

    if-ge v2, v3, :cond_1

    .line 328
    iget v2, p0, Lcom/android/server/BatteryService;->mFreqLimitEnable:I
    ...
    const-string v3, "P14978 mFreqLimitEnabl 0 : wooyub"

    invoke-static {v2, v3}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 332
    iget-object v2, p0, Lcom/android/server/BatteryService;->mFreqLimit:Lcom/pantech/test/Sky_ctrl_drv;

    iget v3, p0, Lcom/android/server/BatteryService;->seteco_one:I

    invoke-virtual {v2, v3}, Lcom/pantech/test/Sky_ctrl_drv;->Sky_Ctrl_Set_Eco(I)I
    ...
    .line 334
    iput v4, p0, Lcom/android/server/BatteryService;->mFreqLimitEnable:I

    .line 349
    .end local v0    # "ret_lim":I
    :cond_0
    :goto_0
    return-void
    ...
    const-string v3, "P14978 mFreqLimitEnabl 1 : wooyub"
    ...
    iget v3, p0, Lcom/android/server/BatteryService;->seteco_zero:I
...
.method private processValuesLocked()V
    ...
    .line 380
    iget-object v0, p0, Lcom/android/server/BatteryService;->mSkyTouch:Lcom/pantech/test/Sky_ctrl_drv;

    const/16 v0, 0x3f1

    const/4 v1, 0x1

    invoke-static {v0, v1}, Lcom/pantech/test/Sky_ctrl_drv;->Sky_Ctrl_Touch(II)I
    :try_end_0
    ...
    .line 422
    invoke-direct {p0}, Lcom/android/server/BatteryService;->battCheckFreqLimit()V
