...
.method static synthetic access$3000()Lcom/android/server/display/DisplayManagerService;
    .locals 1
...
.method private dumpHelp(Ljava/io/PrintWriter;)V
    ...
    .line 2456
    const-string v0, "  --get_rate_slow: Get animation slow rate value."

    invoke-virtual {p1, v0}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    .line 2457
    const-string v0, "  --slow: Set animation slow rate. ex) dumpsys power --slow:80"

    invoke-virtual {p1, v0}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    .line 2458
    const-string v0, "  --get_rate_fast: Get animation fast rate value."

    invoke-virtual {p1, v0}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    .line 2459
    const-string v0, "  --fast: Set animation fast rate. ex) dumpsys power --fast:400"
...
.method public GetLockState()Z
    ...
    invoke-interface {v1}, Landroid/view/WindowManagerPolicy;->GetLockState()Z
...
.method public changeRateFast(I)V
    .locals 3
    .param p1, "rate"    # I
    ...
    const-string v2, "@@@changeRateFast() rate : "
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/power/DisplayPowerController;->changeBrightnessRampRateFast(I)V

    .line 3085
    return-void
.end method

.method public changeRateSlow(I)V
    .locals 3
    .param p1, "rate"    # I
    ...
    const-string v2, "@@@changeRateSlow() rate : "
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/power/DisplayPowerController;->changeBrightnessRampRateSlow(I)V
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v15}, Lcom/android/server/power/PowerManagerService;->changeDebugMode(Z)V

    .line 2488
    const/4 v4, 0x1

    .line 2489
    const-string v15, "PowerManagerService LogSwitch is enable."
    ...
    invoke-virtual {v0, v15}, Lcom/android/server/power/PowerManagerService;->setDispatcherDebug(Z)V

    .line 2492
    const/4 v4, 0x1

    .line 2493
    const-string v15, "InputDispatcher LogSwitch is enable."
    ...
    invoke-virtual {v0, v15}, Lcom/android/server/power/PowerManagerService;->setReaderDebug(Z)V

    .line 2496
    const/4 v4, 0x1

    .line 2497
    const-string v15, "InputReader LogSwitch is enable."
    ...
    invoke-direct {v0, v15}, Lcom/android/server/power/PowerManagerService;->sendLogOnOffIntent(Z)V

    .line 2500
    const/4 v4, 0x1

    .line 2501
    const-string v15, "PhoneWindowManagerService LogSwitch is enable."
    ...
    invoke-direct {v0, v15}, Lcom/android/server/power/PowerManagerService;->setAllLogSwitch(Z)V

    .line 2504
    const/4 v4, 0x1

    .line 2505
    const-string v15, "All LogSwitch is enable."
    ...
    .line 2509
    const-string v15, "All LogSwitch is disable."
    ...
    .line 2510
    :cond_6
    const-string v15, "--get_rate_slow"
    ...
    const-string v16, "@@@dump() --get_rate_slow"

    invoke-static/range {v15 .. v16}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 2512
    invoke-virtual/range {p0 .. p0}, Lcom/android/server/power/PowerManagerService;->getRateSlow()I
    ...
    const-string v16, "Animation slow rate is "
    ...
    invoke-virtual {v0, v15}, Lcom/android/server/power/PowerManagerService;->changeRateSlow(I)V

    .line 2519
    const/4 v4, 0x1

    .line 2520
    const-string v15, "Finished animation slow rate set."
    ...
    :cond_8
    const-string v15, "--get_rate_fast"
    ...
    const-string v16, "@@@dump() --get_rate_fast"

    invoke-static/range {v15 .. v16}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 2523
    invoke-virtual/range {p0 .. p0}, Lcom/android/server/power/PowerManagerService;->getRateFast()I
    ...
    const-string v16, "Animation fast rate is "
    ...
    invoke-virtual {v0, v15}, Lcom/android/server/power/PowerManagerService;->changeRateFast(I)V
    ...
    const-string v16, "Permission Denial: can\'t dump PowerManager from from pid="
    ...
    .line 2551
    :cond_e
    const-string v15, "POWER MANAGER (dumpsys power)\n"
    ...
    .line 2556
    :try_start_0
    const-string v15, "Power Manager State:"
    ...
    invoke-static/range {v17 .. v17}, Lcom/android/server/power/PowerManagerService;->wakefulnessToString(I)Ljava/lang/String;
    ...
    const-string v17, "  mBatteryLevel="
    ...
    const-string v17, "  mBatteryLevelWhenDreamStarted="
    ...
    const-string v17, "  mProximityPositive="
    ...
    const-string v17, "  mBootCompleted="
    ...
    const-string v17, "  mWakeLockSummary=0x"
    ...
    const-string v17, "  mUserActivitySummary=0x"
    ...
    const-string v17, "  mRequestWaitForNegativeProximity="
    ...
    const-string v17, "  mSandmanScheduled="
    ...
    const-string v17, "  mLastWakeTime="
    ...
    const-string v17, "  mLastSleepTime="
    ...
    const-string v17, "  mSendWakeUpFinishedNotificationWhenReady="
    ...
    iget-boolean v0, v0, Lcom/android/server/power/PowerManagerService;->mSendWakeUpFinishedNotificationWhenReady:Z
    ...
    const-string v17, "  mSendGoToSleepFinishedNotificationWhenReady="
    ...
    iget-boolean v0, v0, Lcom/android/server/power/PowerManagerService;->mSendGoToSleepFinishedNotificationWhenReady:Z
    ...
    const-string v17, "  mLastUserActivityTime="
    ...
    const-string v17, "  mLastUserActivityTimeNoChangeLights="
    ...
    const-string v17, "  mDisplayReady="
    ...
    const-string v17, "  mHoldingWakeLockSuspendBlocker="
    ...
    const-string v17, "  mHoldingDisplaySuspendBlocker="
    ...
    .line 2586
    const-string v15, "Settings and Configuration:"
    ...
    const-string v17, "  mWakeUpWhenPluggedOrUnpluggedConfig="
    ...
    const-string v17, "  mSuspendWhenScreenOffDueToProximityConfig="
    ...
    const-string v17, "  mDreamsSupportedConfig="
    ...
    const-string v17, "  mDreamsEnabledByDefaultConfig="
    ...
    const-string v17, "  mDreamsActivatedOnSleepByDefaultConfig="
    ...
    const-string v17, "  mDreamsActivatedOnDockByDefaultConfig="
    ...
    const-string v17, "  mDreamsEnabledSetting="
    ...
    const-string v17, "  mDreamsActivateOnSleepSetting="
    ...
    const-string v17, "  mDreamsActivateOnDockSetting="
    ...
    const-string v17, "  mScreenOffTimeoutSetting="
    ...
    const-string v17, "  mMaximumScreenOffTimeoutFromDeviceAdmin="
    ...
    const-string v17, "  mStayOnWhilePluggedInSetting="
    ...
    const-string v17, "  mScreenBrightnessSetting="
    ...
    const-string v17, "  mScreenAutoBrightnessAdjustmentSetting="
    ...
    const-string v17, "  mScreenBrightnessModeSetting="
    ...
    const-string v17, "  mScreenBrightnessOverrideFromWindowManager="
    ...
    const-string v17, "  mUserActivityTimeoutOverrideFromWindowManager="
    ...
    const-string v17, "  mTemporaryScreenBrightnessSettingOverride="
    ...
    const-string v17, "  mTemporaryScreenAutoBrightnessAdjustmentSettingOverride="
    ...
    const-string v17, "  mScreenBrightnessSettingMinimum="
    ...
    const-string v17, "  mScreenBrightnessSettingMaximum="
    ...
    const-string v17, "  mScreenBrightnessSettingDefault="
    ...
    invoke-direct {v0, v11}, Lcom/android/server/power/PowerManagerService;->getScreenDimDurationLocked(I)I
    ...
    const-string v17, "Screen off timeout: "
    ...
    const-string v17, "Screen dim duration: "
    ...
    const-string v17, "Wake Locks: size="
    ...
    const-string v17, "Suspend Blockers: size="
    ...
    const-string v17, "Screen On Blocker: "
    ...
    iget-object v0, v0, Lcom/android/server/power/PowerManagerService;->mScreenOnBlocker:Lcom/android/server/power/PowerManagerService$ScreenOnBlockerImpl;
    ...
    const-string v17, "Display Blanker: "
...
.method public getRateFast()I
    ...
    invoke-virtual {v1}, Lcom/android/server/power/DisplayPowerController;->getBrightnessRampRateFast()I
    ...
    const-string v3, "@@@getRateFast() rate : "
...
.method public getRateSlow()I
    ...
    invoke-virtual {v1}, Lcom/android/server/power/DisplayPowerController;->getBrightnessRampRateSlow()I
    ...
    const-string v3, "@@@getRateSlow() rate : "
...
.method public hideLocked()V
    ...
    invoke-interface {v0}, Landroid/view/WindowManagerPolicy;->hideLocked()V
...
.method public showLocked(ZLjava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {v0, p1, p2, p3}, Landroid/view/WindowManagerPolicy;->showLocked(ZLjava/lang/String;Ljava/lang/String;)V
