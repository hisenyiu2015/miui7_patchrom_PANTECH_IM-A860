...
.field private pref_mode_db_value:I

.field reginfo:Lcom/android/internal/telephony/gsm/GsmNwRegInfo;
...
.method public constructor <init>(Lcom/android/internal/telephony/gsm/GSMPhone;)V
    ...
    .line 170
    iput v8, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->pref_mode_db_value:I
    ...
    .line 215
    iput-boolean v3, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->isLteOverlay:Z
    ...
    .line 277
    new-instance v3, Lcom/android/internal/telephony/gsm/GsmNwRegInfo;

    invoke-direct {v3, p1, p0}, Lcom/android/internal/telephony/gsm/GsmNwRegInfo;-><init>(Lcom/android/internal/telephony/gsm/GSMPhone;Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;)V

    iput-object v3, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->reginfo:Lcom/android/internal/telephony/gsm/GsmNwRegInfo;
...
.method private pollStateDone()V
    ...
    invoke-virtual/range {v39 .. v39}, Landroid/telephony/ServiceState;->getCSrejCause()I

    move-result v39

    invoke-virtual/range {v37 .. v39}, Landroid/telephony/ServiceState;->setRejCause(II)V
    ...
    invoke-virtual/range {v39 .. v39}, Landroid/telephony/ServiceState;->getPSrejCause()I
    ...
    invoke-virtual/range {v39 .. v39}, Landroid/telephony/ServiceState;->getLTErejCause()I
...
.method public GsstUpdateSpn()V
    ...
    const-string v1, "called  GsstUpdateSpn()............."
...
.method public checkNetworkRejection()Z
    .locals 2

    .prologue
    .line 2352
    iget-object v0, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->reginfo:Lcom/android/internal/telephony/gsm/GsmNwRegInfo;

    invoke-virtual {v0}, Lcom/android/internal/telephony/gsm/GsmNwRegInfo;->isRejectMsgSent()Z
    ...
    const-string v1, "reginfo.isRejectMsgSent() == true"
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-virtual/range {v21 .. v21}, Lcom/android/internal/telephony/gsm/GSMPhone;->getMccInteger()I
    ...
    const-string v22, "[TIME_SET] EVENT_CHECK_MCC_AFTER_NITZ received !!(EVENT_NITZ_TIME + 1sec)"
    ...
    const-string v23, "[TIME_SET] current MCC : "
    ...
    const-string v23, ", time info stored MCC : "
    ...
    invoke-virtual/range {v23 .. v23}, Lcom/android/internal/telephony/gsm/GSMPhone;->getSavedMccInteger()I
    ...
    invoke-virtual/range {v21 .. v21}, Lcom/android/internal/telephony/gsm/GSMPhone;->getSavedMccInteger()I
    ...
    const-string v22, "[TIME_SET] NITZ_TIME_INFO intent is needed !!"
    ...
    const-string v22, "[TIME_SET] send INTENT : NITZ_TIME_INFO"
    ...
    const-string v21, "android.internal.telephony.sky.intent.action.NITZ_TIME_INFO"
    ...
    const-string v23, "[TIME_SET] Time info stored (from NITZ), MCC : "
    ...
    invoke-virtual {v0, v11}, Lcom/android/internal/telephony/gsm/GSMPhone;->saveCurrentMcc(I)V
    ...
    const-string v22, "[TIME_SET] NITZ_TIME_INFO intent is NOT needed !!"
    ...
    const-string v22, "EVENT_SIM_RECORDS_LOADED: what="
    ...
    iget v0, v0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->pref_mode_db_value:I
    ...
    const-string v21, "com.pantech.action.network_mode_select"
    ...
    .line 564
    const-string v21, "network_mode_select"
    ...
    iput v13, v0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->pref_mode_db_value:I
    ...
    const-string v23, "modemNetworkMode : "
    ...
    const-string v23, "  settingsNetworkMode:"
    ...
    .end local v4    # "ar":Landroid/os/AsyncResult;
    .end local v7    # "i":Landroid/content/Intent;
    .end local v13    # "modemNetworkMode":I
    .end local v17    # "settingsNetworkMode":I
    :sswitch_13
    const-string v21, "GsmSST"

    const-string v22, "--- EVENT_UPDATE_LTE_OVERLAY_INFO ---"
    ...
    iget-boolean v0, v0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->isLteOverlay:Z

    move/from16 v22, v0

    invoke-virtual/range {v21 .. v22}, Lcom/android/internal/telephony/gsm/GSMPhone;->setLteOverlay(Z)V
...
.method protected handlePollStateResult(ILandroid/os/AsyncResult;)V
    ...
    invoke-direct {v0, v1, v2}, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->isRoamingCompensation(ZLandroid/telephony/ServiceState;)Z
    ...
    iput-boolean v0, v1, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->isLteOverlay:Z
    ...
    const-string v25, "fake_roaming_mode_setting"
    ...
    invoke-virtual/range {v25 .. v25}, Lcom/android/internal/telephony/gsm/GSMPhone;->getSubscription()I
    ...
    invoke-direct {v0, v1}, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->regCodeToServiceState2(I)I

    move-result v25

    invoke-virtual/range {v24 .. v25}, Landroid/telephony/ServiceState;->setSubState(I)V
    ...
    iget-object v0, v0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->reginfo:Lcom/android/internal/telephony/gsm/GsmNwRegInfo;

    move-object/from16 v26, v0

    invoke-virtual/range {v26 .. v26}, Lcom/android/internal/telephony/gsm/GsmNwRegInfo;->getLteRejectCause()I

    move-result v26

    invoke-virtual/range {v24 .. v26}, Landroid/telephony/ServiceState;->setRejCause(II)V
    ...
    invoke-virtual/range {v26 .. v26}, Lcom/android/internal/telephony/gsm/GsmNwRegInfo;->getGwCsRejectCause()I
    ...
    invoke-virtual/range {v26 .. v26}, Lcom/android/internal/telephony/gsm/GsmNwRegInfo;->getGwPsRejectCause()I
    ...
    invoke-virtual/range {v26 .. v26}, Landroid/telephony/ServiceState;->getLTErejCause()I
    ...
    invoke-virtual/range {v26 .. v26}, Landroid/telephony/ServiceState;->getCSrejCause()I
    ...
    invoke-virtual/range {v26 .. v26}, Landroid/telephony/ServiceState;->getPSrejCause()I
    ...
    .restart local v20    # "reportDelay":I
    :cond_13
    const/16 v20, 0xbb8
    ...
    const-string v25, "RoamingTest_L"
    ...
    const-string v25, "RoamingTest_S"
    ...
    invoke-interface/range {v24 .. v25}, Lcom/android/internal/telephony/CommandsInterface;->getPreferredNetworkType(Landroid/os/Message;)V
    ...
    const-string v25, "network_selection_mode"
    ...
    .line 999
    .local v4, "android_nsm":Ljava/lang/String;
    if-nez v4, :cond_1b
    ...
    .line 1005
    .local v14, "modem_nsm":Ljava/lang/String;
    :goto_a
    ...
    .line 977
    .end local v4    # "android_nsm":Ljava/lang/String;
    .end local v14    # "modem_nsm":Ljava/lang/String;
    :cond_1c
    const/16 v24, 0x0
    ...
    .line 1004
    .restart local v4    # "android_nsm":Ljava/lang/String;
    :cond_1d
...
.method protected updateSpnDisplay()V
    ...
    .line 645
    iget-object v10, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->reginfo:Lcom/android/internal/telephony/gsm/GsmNwRegInfo;

    invoke-virtual {v10}, Lcom/android/internal/telephony/gsm/GsmNwRegInfo;->isRejectMsgSent()Z
    ...
    const-string v9, "updateSpnDisplay() is ignored..  reject msg is displayed !"
