...
.field static methodPutClassLoader:Ljava/lang/reflect/Method;
...
.method public static getClassLoader(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/ClassLoader;
    .locals 8
    ...
    .line 735
    :try_start_0
    const-string v1, "com.pantech.app.SkySettingFramework.Ut"
    ...
    sput-object v3, Landroid/app/Fragment;->methodPutClassLoader:Ljava/lang/reflect/Method;

    .line 738
    sget-object v3, Landroid/app/Fragment;->methodPutClassLoader:Ljava/lang/reflect/Method;
...
.method public static instantiate(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;)Landroid/app/Fragment;
    ...
    .line 606
    invoke-static {p0, p1, p2}, Landroid/app/Fragment;->instantiate_Package(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;)Landroid/app/Fragment;
...
.method public static instantiate_Package(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;)Landroid/app/Fragment;
    .locals 10
    .param p0, "context"    # Landroid/content/Context;
    .param p1, "fname"    # Ljava/lang/String;
    .param p2, "args"    # Landroid/os/Bundle;
    ...
    const-string v8, "instantiate context packagename is not valid!!"
    ...
    :try_start_0
    invoke-static {p0, v5}, Landroid/app/Fragment;->getClassLoader(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/ClassLoader;
    ...
    invoke-static {p0, v5, v1}, Landroid/app/Fragment;->putClassLoader(Landroid/content/Context;Ljava/lang/String;Ljava/lang/ClassLoader;)V
    ...
    invoke-virtual {v7, p1, v2}, Landroid/util/ArrayMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    :try_end_0
...
.method public static putClassLoader(Landroid/content/Context;Ljava/lang/String;Ljava/lang/ClassLoader;)V
    .locals 7
    .param p0, "context"    # Landroid/content/Context;
    .param p1, "pname"    # Ljava/lang/String;
    ...
    .line 711
    .local v0, "c":Ljava/lang/Class;, "Ljava/lang/Class<*>;"
    const-string/jumbo v3, "putClassLoader"
...
.method public final getResources()Landroid/content/res/Resources;
    ...
    .line 893
    :cond_0
    invoke-virtual {p0}, Landroid/app/Fragment;->getResourcesFromOtherPackage()Landroid/content/res/Resources;
...
.method protected getResourcesFromOtherPackage()Landroid/content/res/Resources;
    .locals 1
