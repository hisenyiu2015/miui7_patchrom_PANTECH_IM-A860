...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-static {v5}, Landroid/hardware/Camera;->access$1200(Landroid/hardware/Camera;)Z
    ...
    invoke-static {v5, v6}, Landroid/hardware/Camera;->access$1300(Landroid/hardware/Camera;I)Z

    .line 1229
    iget-object v5, p0, Landroid/hardware/Camera$EventHandler;->this$0:Landroid/hardware/Camera;

    # setter for: Landroid/hardware/Camera;->mIsPreview:Z
    invoke-static {v5, v4}, Landroid/hardware/Camera;->access$1202(Landroid/hardware/Camera;Z)Z
    ...
    invoke-static {v5}, Landroid/hardware/Camera;->access$1400(Landroid/hardware/Camera;)Landroid/hardware/Camera$ErrorCallback;
    ...
    invoke-static {v6}, Landroid/hardware/Camera;->access$1500(Landroid/hardware/Camera;)Landroid/hardware/Camera$AutoFocusMoveCallback;
    ...
    invoke-static {v5, v6}, Landroid/hardware/Camera;->access$1600([BI)I
    ...
    invoke-static {v5}, Landroid/hardware/Camera;->access$1700(Landroid/hardware/Camera;)Landroid/hardware/Camera$CameraDataCallback;
    ...
    invoke-static {v5}, Landroid/hardware/Camera;->access$1800(Landroid/hardware/Camera;)Landroid/hardware/Camera$CameraMetaDataCallback;
