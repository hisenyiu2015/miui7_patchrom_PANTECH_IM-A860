...
.method public constructor <init>()V
    ...
    .line 209
    iput v0, p0, Landroid/telephony/ServiceState;->mCSrejCause:I

    .line 210
    iput v0, p0, Landroid/telephony/ServiceState;->mPSrejCause:I

    .line 211
    iput v0, p0, Landroid/telephony/ServiceState;->mLTErejCause:I
...
.method public constructor <init>(Landroid/os/Parcel;)V
    ...
    .line 209
    iput v2, p0, Landroid/telephony/ServiceState;->mCSrejCause:I

    .line 210
    iput v2, p0, Landroid/telephony/ServiceState;->mPSrejCause:I

    .line 211
    iput v2, p0, Landroid/telephony/ServiceState;->mLTErejCause:I
...
.method private setFromNotifierBundle(Landroid/os/Bundle;)V
    ...
    .line 822
    const-string/jumbo v0, "ps-rejCause"
...
.method protected copyFrom(Landroid/telephony/ServiceState;)V
    ...
    .line 269
    iget v0, p1, Landroid/telephony/ServiceState;->mCSrejCause:I

    iput v0, p0, Landroid/telephony/ServiceState;->mCSrejCause:I

    .line 270
    iget v0, p1, Landroid/telephony/ServiceState;->mPSrejCause:I

    iput v0, p0, Landroid/telephony/ServiceState;->mPSrejCause:I

    .line 271
    iget v0, p1, Landroid/telephony/ServiceState;->mLTErejCause:I
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget v4, p0, Landroid/telephony/ServiceState;->mCSrejCause:I

    iget v5, v2, Landroid/telephony/ServiceState;->mCSrejCause:I

    if-ne v4, v5, :cond_0

    iget v4, p0, Landroid/telephony/ServiceState;->mPSrejCause:I

    iget v5, v2, Landroid/telephony/ServiceState;->mPSrejCause:I

    if-ne v4, v5, :cond_0

    iget v4, p0, Landroid/telephony/ServiceState;->mLTErejCause:I

    iget v5, v2, Landroid/telephony/ServiceState;->mLTErejCause:I
...
.method public fillInNotifierBundle(Landroid/os/Bundle;)V
    ...
    iget v1, p0, Landroid/telephony/ServiceState;->mCSrejCause:I
    ...
    iget v1, p0, Landroid/telephony/ServiceState;->mPSrejCause:I
    ...
    iget v1, p0, Landroid/telephony/ServiceState;->mLTErejCause:I
...
.method public getCSrejCause()I
    .locals 1

    .prologue
    .line 1035
    iget v0, p0, Landroid/telephony/ServiceState;->mCSrejCause:I
...
.method public getLTErejCause()I
    .locals 1

    .prologue
    .line 1045
    iget v0, p0, Landroid/telephony/ServiceState;->mLTErejCause:I
...
.method public getPSrejCause()I
    .locals 1

    .prologue
    .line 1040
    iget v0, p0, Landroid/telephony/ServiceState;->mPSrejCause:I
...
.method public setRejCause(II)V
    .locals 2
    .param p1, "rejDomain"    # I
    .param p2, "rejCause"    # I
    ...
    iput p2, p0, Landroid/telephony/ServiceState;->mLTErejCause:I
    ...
    iput p2, p0, Landroid/telephony/ServiceState;->mCSrejCause:I
    ...
    iput p2, p0, Landroid/telephony/ServiceState;->mPSrejCause:I

    goto :goto_0

    .line 1027
    :cond_2
    iput v1, p0, Landroid/telephony/ServiceState;->mCSrejCause:I

    .line 1028
    iput v1, p0, Landroid/telephony/ServiceState;->mPSrejCause:I

    .line 1029
    iput v1, p0, Landroid/telephony/ServiceState;->mLTErejCause:I
