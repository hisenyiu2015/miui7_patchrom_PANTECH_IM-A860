...
.method private dump(Ljava/io/PrintWriter;)V
    ...
    .line 3385
    invoke-direct {p0, p1}, Landroid/media/AudioService$VolumeStreamState;->printCallingPackage(Ljava/io/PrintWriter;)V
...
.method private getDeathHandler(Landroid/os/IBinder;ZLjava/lang/String;)Landroid/media/AudioService$VolumeStreamState$VolumeDeathHandler;
    .locals 6
    ...
    invoke-direct {v0, p0, p1, p3}, Landroid/media/AudioService$VolumeStreamState$VolumeDeathHandler;-><init>(Landroid/media/AudioService$VolumeStreamState;Landroid/os/IBinder;Ljava/lang/String;)V
...
.method private declared-synchronized printCallingPackage(Ljava/io/PrintWriter;)V
    .locals 4
    .param p1, "pw"    # Ljava/io/PrintWriter;
    ...
    :try_start_0
    iget-object v2, p0, Landroid/media/AudioService$VolumeStreamState;->mDeathHandlers:Ljava/util/ArrayList;
    ...
    check-cast v2, Landroid/media/AudioService$VolumeStreamState$VolumeDeathHandler;

    # getter for: Landroid/media/AudioService$VolumeStreamState$VolumeDeathHandler;->mCallingPackage:Ljava/lang/String;
    invoke-static {v2}, Landroid/media/AudioService$VolumeStreamState$VolumeDeathHandler;->access$4500(Landroid/media/AudioService$VolumeStreamState$VolumeDeathHandler;)Ljava/lang/String;
...
.method public declared-synchronized mute(Landroid/os/IBinder;Z)V
    ...
    :try_start_0
    invoke-virtual {p0, p1, p2, v0}, Landroid/media/AudioService$VolumeStreamState;->mute(Landroid/os/IBinder;ZLjava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized mute(Landroid/os/IBinder;ZLjava/lang/String;)V
    .locals 4
    .param p1, "cb"    # Landroid/os/IBinder;
    .param p2, "state"    # Z
    .param p3, "callingPackage"    # Ljava/lang/String;
    ...
    :try_start_0
    invoke-direct {p0, p1, p2, p3}, Landroid/media/AudioService$VolumeStreamState;->getDeathHandler(Landroid/os/IBinder;ZLjava/lang/String;)Landroid/media/AudioService$VolumeStreamState$VolumeDeathHandler;
