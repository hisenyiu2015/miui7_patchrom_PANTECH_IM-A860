...
.method public handleMessage(Landroid/os/Message;)V
    ...
    # getter for: Landroid/media/MediaPlayer;->mAOTApp:Z
    invoke-static {v5}, Landroid/media/MediaPlayer;->access$800(Landroid/media/MediaPlayer;)Z

    move-result v5

    invoke-virtual {v4, v5}, Landroid/media/MediaPlayer;->setAOT(Z)V
    ...
    invoke-static {v5}, Landroid/media/MediaPlayer;->access$900(Landroid/media/MediaPlayer;)Landroid/media/MediaPlayer$OnCompletionListener;
    ...
    invoke-static {v5, v4}, Landroid/media/MediaPlayer;->access$1000(Landroid/media/MediaPlayer;Z)V
    ...
    # invokes: Landroid/media/MediaPlayer;->sendMediaStateEvent(I)Z
    invoke-static {v5, v6}, Landroid/media/MediaPlayer;->access$1500(Landroid/media/MediaPlayer;I)Z
    ...
    invoke-static {v5}, Landroid/media/MediaPlayer;->access$1600(Landroid/media/MediaPlayer;)Landroid/media/MediaPlayer$OnErrorListener;
    ...
    invoke-static {v4}, Landroid/media/MediaPlayer;->access$1700(Landroid/media/MediaPlayer;)Landroid/media/MediaPlayer$OnInfoListener;
    ...
    invoke-static {v4}, Landroid/media/MediaPlayer;->access$1800(Landroid/media/MediaPlayer;)Landroid/media/MediaPlayer$OnTimedTextListener;
    ...
    invoke-static {v4}, Landroid/media/MediaPlayer;->access$1900(Landroid/media/MediaPlayer;)Landroid/media/MediaPlayer$OnSubtitleDataListener;
