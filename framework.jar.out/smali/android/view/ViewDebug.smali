...
.field private static final REMOTE_COMMAND_PAT_DUMP:Ljava/lang/String; = "PAT_DUMP"

.field private static final REMOTE_COMMAND_PAT_DUMPVIEW:Ljava/lang/String; = "PAT_DUMPVIEW"

.field private static final REMOTE_COMMAND_PAT_FOCUSVIEW:Ljava/lang/String; = "PAT_FOCUSVIEW"

.field private static final REMOTE_COMMAND_PAT_REQUESTVIEW:Ljava/lang/String; = "PAT_REQUESTVIEW"

.field private static final REMOTE_COMMAND_PAT_SCROLLVIEW:Ljava/lang/String; = "PAT_SCROLLVIEW"

.field private static final REMOTE_COMMAND_PAT_SETEDITTEXT:Ljava/lang/String; = "PAT_SETEDITTEXT"
...
.method private static PATDumpView(Landroid/view/View;Ljava/io/OutputStream;Ljava/lang/String;)V
    .locals 8
    ...
    invoke-static {v6, v2, v4, v7}, Landroid/view/ViewDebug;->PATdumpViewHierarchyWithProperties(Landroid/content/Context;Landroid/view/ViewGroup;Ljava/io/BufferedWriter;I)V
    ...
    invoke-static {v6, v5, v4, v7}, Landroid/view/ViewDebug;->PATdumpViewWithProperties(Landroid/content/Context;Landroid/view/View;Ljava/io/BufferedWriter;I)Z
    :try_end_2
    ...
    const-string v7, "Problem PAT Dump view:"
...
.method private static PATFocusView(Landroid/view/View;Ljava/io/OutputStream;Ljava/lang/String;)V
    .locals 6
    .param p0, "root"    # Landroid/view/View;
    .param p1, "clientStream"    # Ljava/io/OutputStream;
    .param p2, "parameter"    # Ljava/lang/String;
    ...
    const-string v5, "Problem PATFocusView:"
...
.method private static PATRequestView(Landroid/view/View;Ljava/io/OutputStream;Ljava/lang/String;)V
    .locals 6
    .param p0, "root"    # Landroid/view/View;
    .param p1, "clientStream"    # Ljava/io/OutputStream;
    .param p2, "parameter"    # Ljava/lang/String;
    ...
    invoke-static {v4, v3, v2, v5}, Landroid/view/ViewDebug;->PATdumpViewWithProperties(Landroid/content/Context;Landroid/view/View;Ljava/io/BufferedWriter;I)Z
    ...
    const-string v5, "Problem PATRequestView:"
...
.method private static PATScrollView(Landroid/view/View;Ljava/io/OutputStream;Ljava/lang/String;)V
    .locals 13
    .param p0, "root"    # Landroid/view/View;
    .param p1, "clientStream"    # Ljava/io/OutputStream;
    ...
    invoke-static {p0, v10}, Landroid/view/ViewDebug;->findView(Landroid/view/View;Ljava/lang/String;)Landroid/view/View;
    ...
    invoke-virtual {v1, v10}, Landroid/widget/AdapterView;->post(Ljava/lang/Runnable;)Z
    ...
    const-string v11, "Problem PATScrollToView:"
...
.method private static PATSetEditText(Landroid/view/View;Ljava/io/OutputStream;Ljava/lang/String;)V
    .locals 11
    .param p0, "root"    # Landroid/view/View;
    .param p1, "clientStream"    # Ljava/io/OutputStream;
    .param p2, "parameters"    # Ljava/lang/String;
    ...
    :goto_0
    invoke-static {p0, v8}, Landroid/view/ViewDebug;->findView(Landroid/view/View;Ljava/lang/String;)Landroid/view/View;
    ...
    invoke-virtual {v2, v9}, Landroid/widget/EditText;->post(Ljava/lang/Runnable;)Z
    ...
    const-string v10, "Problem PATSetEditText:"
...
.method private static PATdump(Landroid/view/View;Ljava/io/OutputStream;)V
    .locals 8
    .param p0, "root"    # Landroid/view/View;
    .param p1, "clientStream"    # Ljava/io/OutputStream;
    .annotation system Ldalvik/annotation/Throws;
...
.method private static PATdumpViewHierarchyWithProperties(Landroid/content/Context;Landroid/view/ViewGroup;Ljava/io/BufferedWriter;I)V
    .locals 4
    ...
    .prologue
    .line 867
    invoke-static {p0, p1, p2, p3}, Landroid/view/ViewDebug;->PATdumpViewWithProperties(Landroid/content/Context;Landroid/view/View;Ljava/io/BufferedWriter;I)Z
    ...
    invoke-static {p0, v2, p2, v3}, Landroid/view/ViewDebug;->PATdumpViewHierarchyWithProperties(Landroid/content/Context;Landroid/view/ViewGroup;Ljava/io/BufferedWriter;I)V
    ...
    invoke-static {p0, v2, p2, v3}, Landroid/view/ViewDebug;->PATdumpViewWithProperties(Landroid/content/Context;Landroid/view/View;Ljava/io/BufferedWriter;I)Z

    goto :goto_1
.end method

.method private static PATdumpViewWithProperties(Landroid/content/Context;Landroid/view/View;Ljava/io/BufferedWriter;I)Z
    .locals 22
    .param p0, "context"    # Landroid/content/Context;
    ...
    .line 917
    .local v13, "mRect":Landroid/graphics/Rect;
    move-object/from16 v0, p1
    ...
    const-string v21, ",willNotDraw="

    invoke-virtual/range {v20 .. v21}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v20

    invoke-virtual/range {p1 .. p1}, Landroid/view/View;->willNotDraw()Z
    ...
    invoke-virtual/range {v20 .. v20}, Landroid/widget/CheckedTextView;->isChecked()Z
    ...
    invoke-virtual/range {v20 .. v20}, Landroid/widget/AdapterView;->getFirstVisiblePosition()I
    ...
    invoke-virtual/range {v20 .. v20}, Landroid/widget/AdapterView;->getLastVisiblePosition()I
    ...
    .line 1009
    .end local v4    # "cocunt":I
    .end local v7    # "fpos":I
    .end local v12    # "lpos":I
    :cond_6
    ...
    .end local v11    # "lefttop":[I
    .end local v13    # "mRect":Landroid/graphics/Rect;
    .end local v14    # "parent":Landroid/view/ViewParent;
    .end local v17    # "rotateValue":F
    .end local v19    # "top":I
    :goto_4
    return v20
    ...
    const-string v21, "Error while dumping hierarchy tree"
    ...
    .restart local v9    # "id":I
    .restart local v11    # "lefttop":[I
    .restart local v13    # "mRect":Landroid/graphics/Rect;
    .restart local v14    # "parent":Landroid/view/ViewParent;
    .restart local v17    # "rotateValue":F
    :cond_8
    :try_start_3
    move-object v0, v14
    ...
    .line 930
    .local v15, "parentView":Landroid/view/View;
    ...
    .line 938
    .end local v15    # "parentView":Landroid/view/View;
...
.method private static callMethodOnAppropriateTheadBlocking(Ljava/lang/reflect/Method;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 1399
    .local v5, "view":Landroid/view/View;
    new-instance v0, Landroid/view/ViewDebug$11;

    invoke-direct {v0, p0, v5}, Landroid/view/ViewDebug$11;-><init>(Ljava/lang/reflect/Method;Landroid/view/View;)V
...
.method static dispatchCommand(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/io/OutputStream;)V
    ...
    .line 436
    invoke-static {p0, p3}, Landroid/view/ViewDebug;->PATdump(Landroid/view/View;Ljava/io/OutputStream;)V
    ...
    .line 441
    :cond_3
    const-string v1, "PAT_SETEDITTEXT"
    ...
    .line 442
    invoke-static {p0, p3, p2}, Landroid/view/ViewDebug;->PATSetEditText(Landroid/view/View;Ljava/io/OutputStream;Ljava/lang/String;)V

    goto :goto_0

    .line 443
    :cond_4
    const-string v1, "PAT_SCROLLVIEW"
    ...
    .line 444
    invoke-static {p0, p3, p2}, Landroid/view/ViewDebug;->PATScrollView(Landroid/view/View;Ljava/io/OutputStream;Ljava/lang/String;)V
    ...
    invoke-static {p0, p3, v1}, Landroid/view/ViewDebug;->PATDumpView(Landroid/view/View;Ljava/io/OutputStream;Ljava/lang/String;)V

    goto/16 :goto_0

    .line 461
    :cond_b
    const-string v1, "PAT_REQUESTVIEW"
    ...
    invoke-static {p0, p3, v1}, Landroid/view/ViewDebug;->PATRequestView(Landroid/view/View;Ljava/io/OutputStream;Ljava/lang/String;)V

    goto/16 :goto_0

    .line 463
    :cond_c
    const-string v1, "PAT_FOCUSVIEW"
    ...
    invoke-static {p0, p3, v1}, Landroid/view/ViewDebug;->PATFocusView(Landroid/view/View;Ljava/io/OutputStream;Ljava/lang/String;)V
...
.method public static invokeViewMethod(Landroid/view/View;Ljava/lang/reflect/Method;[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    new-instance v0, Landroid/view/ViewDebug$12;
    ...
    invoke-direct/range {v0 .. v6}, Landroid/view/ViewDebug$12;-><init>(Ljava/util/concurrent/atomic/AtomicReference;Ljava/lang/reflect/Method;Landroid/view/View;[Ljava/lang/Object;Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/CountDownLatch;)V
...
.method public static setLayoutParameter(Landroid/view/View;Ljava/lang/String;I)V
    ...
    .line 1900
    new-instance v2, Landroid/view/ViewDebug$13;

    invoke-direct {v2, p0, v1}, Landroid/view/ViewDebug$13;-><init>(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
