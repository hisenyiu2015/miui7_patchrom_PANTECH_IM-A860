...
.field public static final ACTION_DEVICE_DETAIL_SEARCH:Ljava/lang/String; = "android.bluetooth.adapter.action.ACTION_DEVICE_DETAIL_SEARCH"
...
.field public static final ACTION_UPDATE_BT_MDM_POLICY:Ljava/lang/String; = "com.android.bluetooth.action.UPDATE_BT_MDM_POLICY"
...
.field public static final BT_EXCEPTION_POLICY_VIOLATION:Ljava/lang/String; = "Bluetooth Device Policy violation"
...
.method public configRFDutTest(Z)Z
    .locals 5
    .param p1, "enable"    # Z
    ...
    const-string v4, "[PANTECH]Adapter configRFDutTest ="
    ...
    invoke-interface {v1, p1}, Landroid/bluetooth/IBluetooth;->configRFDutTest(Z)Z
...
.method public configSSPDebugMode(Z)Z
    .locals 5
    .param p1, "enable"    # Z
    ...
    const-string v4, "[PANTECH]Adapter configSSPDebugMode ="
    ...
    invoke-interface {v1, p1}, Landroid/bluetooth/IBluetooth;->configSSPDebugMode(Z)Z
...
.method public getBluetoothDevicePolicy()I
    ...
    invoke-interface {v1}, Landroid/bluetooth/IBluetoothManager;->getBluetoothDevicePolicy()I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public getPowerOffPossible()Z
    ...
    invoke-interface {v1}, Landroid/bluetooth/IBluetoothManager;->getPowerOffPossible()Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
